...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.saveImageButton.setMaximumSize(QSize(80, 16777215))
        self.horizontalLayout_4.addWidget(self.saveImageButton)
        self.selectInputFacesButton = QPushButton(self.facesPanelGroupBox)
        self.selectInputFacesButton.setObjectName(u"selectInputFacesButton")
        self.selectInputFacesButton.setText("全选")
        self.selectInputFacesButton.setMaximumSize(QSize(50, 16777215))
        self.horizontalLayout_4.addWidget(self.selectInputFacesButton)
